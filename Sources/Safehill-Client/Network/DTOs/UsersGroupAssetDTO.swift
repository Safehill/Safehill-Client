...
public class UsersGroupAssetClass: NSObject, NSSecureCoding {
    ...
    static func fromDTO(_ userGroupAsset: UsersGroupAssetDTO) -> UsersGroupAssetClass {
        UsersGroupAssetClass(
    ...
    static func fromData(_ data: Data) throws -> UsersGroupAssetClass? {
